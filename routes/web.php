...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('category_edit', ['as' => 'menu.category_edit', 'uses' => 'CategoryController@edit']);
...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('dishes_edit', ['as' => 'menu.dishes_edit', 'uses' => 'DishesController@edit']);
	Route::get('dishes_add', ['as' => 'menu.dishes_add', 'uses' => 'DishesController@add']);
	Route::get('dishes_detail', ['as' => 'menu.detail', 'uses' => 'DishesController@detail']);
});
